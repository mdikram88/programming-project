...
class CafeForm(FlaskForm):
    ...
    close = StringField('Closing Time eg 8:30 PM', validators=[DataRequired()])
    coffee_rating = SelectField('Coffee Rating', choices=COFFEE_CHOICES, validators=[DataRequired()])
    wifi_rating = SelectField('Wi-Fi Rating', choices=WIFI_CHOICES, validators=[DataRequired()])
    power_rating = SelectField('Power Rating', choices=POWER_CHOICE, validators=[DataRequired()])
